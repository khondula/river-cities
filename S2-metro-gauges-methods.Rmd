...
To view gauges for a given city based on its [GEOID](https://github.com/khondula/river-cities/blob/master/river-cities-data/reference-tables/cbsa-geoids.csv). Click a marker to see info about the site and discharge record. 
